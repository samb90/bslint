...
RULES_LIST = {
    ...
    const.PRIORITY_SIX: {
        const.ID: [
            ...
            ([const.IF_STMT, const.ID], const.BLOCK_STMT),
            ([const.ELSE_IF_STMT, const.ID], const.BLOCK_STMT),
            ([const.IF_STMT, const.THEN, const.ID], const.BLOCK_STMT),
            ([const.ELSE_IF_STMT, const.THEN, const.ID], const.BLOCK_STMT),
        ],
        const.VALUE: [
            ...
            ([const.IF_STMT, const.VALUE], const.BLOCK_STMT),
            ([const.ELSE_IF_STMT, const.VALUE], const.BLOCK_STMT),
            ([const.IF_STMT, const.THEN, const.VALUE], const.BLOCK_STMT),
            ([const.ELSE_IF_STMT, const.THEN, const.VALUE], const.BLOCK_STMT),
        ...
        const.FUNCTION_CALL: [
            ...
            ([const.IF_STMT, const.FUNCTION_CALL], const.BLOCK_STMT),
            ([const.ELSE_IF_STMT, const.FUNCTION_CALL], const.BLOCK_STMT),
        ...
        const.VAR_AS: [
            ...
            ([const.IF_STMT, const.VAR_AS], const.BLOCK_STMT),
